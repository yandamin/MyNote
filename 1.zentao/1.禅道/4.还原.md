...
5.  把zentaopro_85/config/my.php 拷贝到zentao/config/下面；
6.  把zentaopro_85/www/data/upload整个文件夹拷贝到zentao/www/data/下面；
7.  把zentaopro_85/www/下面的 .ztaccess .htaccess 拷给到zentao/www/下面；
8.  把/opt/zbox/app/zentao/www/ 下面的 install.php、upgrade.php 删除；
9.  登录数据库 zt_config 表 把版本号改成 11.6；
